...
axes.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(plot_dir, f'dofs_vs_qoi_error_{config}_2d.pdf'))
fig, axes = plt.subplots()
...
axes.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(plot_dir, f'dofs_vs_qoi_error_semilogx_{config}_2d.pdf'))
...
axes.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(plot_dir, f'dofs_vs_qoi_{config}_2d.pdf'))
...
plt.savefig(os.path.join(plot_dir, 'legend_2d.pdf'), bbox_inches=bbox)
